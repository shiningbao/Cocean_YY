...
public class ApprovalController {
	...
	public ModelAndView draftDetail(HttpSession session, RedirectAttributes rAttr, @RequestParam int idx,
			int employeeID) {
		ModelAndView mav = new ModelAndView();
		LoginDTO dto = (LoginDTO) session.getAttribute("userInfo");
		if (dto != null) {
...
//	}
	 ...
	 * 
	 * @PostMapping(value="/approval/saveApprovalLine.do", consumes =
	 * MediaType.APPLICATION_JSON_VALUE)
	 * 
	 * @ResponseBody public Map<String, Object> saveApprovalLine(@RequestBody
	 * List<Map<String, Object>> lineData) { logger.info("params: {}", lineData);
	 ...
	 * 
	 * Map<String, Object> result = new HashMap<>(); result.put("lineData",
	 * lineData); return result; }
	 * 
	 * @GetMapping(value="/approval/getData.do")
	 * 
	 * @ResponseBody public Map<String, Object> getData() { Map<String, Object>
	 * result = new HashMap<>(); result.put("lineData", savedLineData);
