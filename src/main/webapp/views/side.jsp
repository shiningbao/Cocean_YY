			...
			<nav class="col-md-3 float-left col-1 pl-0 pr-0 collapse width show"
				...
				<div class="list-group border-0 card text-center text-md-left">
					...
					<div class="collapse" id="store_bar">
						<a href="#" class="list-group-item" data-parent="#sidebar">지점
							관리</a> <a href="#" class="list-group-item" data-parent="#sidebar">상품
							관리</a>
					</div>
					<a href="#group_bar"
						class="list-group-item d-inline-block collapsed"
					...
					<div class="collapse" id="group_bar">
						<a href="#" class="list-group-item" data-parent="#sidebar">조직
							관리</a> <a href="#" class="list-group-item" data-parent="#sidebar">사원
							관리</a> <a href="#" class="list-group-item" data-parent="#sidebar">연차
							관리</a>
					</div>
					<a href="#" class="list-group-item d-inline-block collapsed"
						data-parent="#sidebar"> <img
					...
					<div class="collapse" id="board_bar">
						...
						<a href="#" class="list-group-item" data-parent="#sidebar">프로그램
							일정</a>
					</div>
					<a href="#" class="list-group-item d-inline-block collapsed"
						data-parent="#sidebar"> <img
